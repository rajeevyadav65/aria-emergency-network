...
public class LocationShareController {
    ...
    @PostMapping({"/location/share", "/location-tracking/share"})
    public ResponseEntity<Map<String, Object>> startSharing(
        ...
        Long emergencyId = body.containsKey("emergencyId")
                ? Long.valueOf(body.get("emergencyId").toString())
                : null;
    ...
    @DeleteMapping({"/location/share/{sessionId}", "/location-tracking/share/{sessionId}"})
    ...
    @GetMapping({"/location/share/active", "/location-tracking/share/active"})
    ...
    @GetMapping({"/location/history/{deviceId}", "/location-tracking/history/{deviceId}"})
    public ResponseEntity<List<LocationHistory>> getHistory(@PathVariable String deviceId) {
